...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-md border-b border-border transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-teal-600 to-green-600 flex items-center justify-center text-white shadow-md shadow-teal-500/20">
              <BookOpen className="h-6 w-6" />
            </div>
            <div>
              <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-green-600 dark:from-teal-400 dark:to-green-400">
                LectureHub
              </span>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-teal-50/50 via-transparent to-transparent dark:from-teal-950/20 py-12 border-b border-border">
        <div className="max-w-4xl mx-auto text-center px-4">
          <span className="bg-teal-100 dark:bg-teal-900/40 text-teal-700 dark:text-teal-300 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
            Lecture Materials Repository
          </span>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight mt-4 mb-3">
            Browse & Access Learning Materials
          </h1>
          <p className="text-muted-foreground text-sm sm:text-base max-w-2xl mx-auto leading-relaxed">
            Find, preview, and download lecture notes, slides, and study materials organized by topic and week.
          </p>
        ...
        <aside className="w-full lg:w-72 shrink-0 flex flex-col gap-6">
          <div className="bg-card border border-border rounded-2xl p-5 shadow-sm space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Search Materials</label>
            ...
            {/* Level Select */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Week</label>
